...
export const RESERVATION_PROCESS_STATE = {
  ...
  ABANDONED: 'ABANDONED_NO_PAYMENT_ATTEMP', // Not a typo, don't correct it
};
...
export const RESERVATION_STATUS = {
  ...
  VERIFYING: 'VERIFYING',
  PAYING: 'PAYING',
  PAID_OVERPAID: 'PAID_OVERPAID',
  FROZEN: 'FROZEN',
  WAITLIST: 'WAITLIST',
  SUSPENDED: 'SUSPENDED',
  CANCELLED: 'CANCELLED',
  CONFIRMED: 'CONFIRMED',
  CONFIRMED_OVERPAY: 'CONFIRMED_OVERPAY',
  GUARANTEE_CC: 'GUARANTEE_CC',
...
export const PAYMENT_METHODS = {
  TRANSFER_OR_DEPOSIT: 'TRANSFER_OR_DEPOSIT',
  KHIPU: 'KHIPU',
  PAYPAL: 'PAYPAL',
  '123PAGO': '123PAGO',
  ...
  INSTAPAGO: 'INSTAPAGO',
  WEBPAY_BY_HOTEL: 'WEBPAY_BY_HOTEL',
  WEBPAY_PLUS: 'WEBPAY_PLUS',
  GUARANTEE_BY_CC: 'GUARANTEE_BY_CC',
  STRIPE: 'STRIPE',
};

export const SALES_ORIGIN_TYPE = {
  DIRECT: 'direct',
  REG: 'reg',
  IDS: 'ids',
  OTA: 'ota',
...
export const PROCECESS_STATE = {
  CREATED: 'CREATED',
  FAILED_NO_QUOTAS: 'FAILED_NO_QUOTAS',
  ABANDONED_NO_PAYMENT_ATTEMP: 'ABANDONED_NO_PAYMENT_ATTEMP',
  WAITING_FOR_PAYMNET: 'WAITING_FOR_PAYMNET',
  SUCCESS_PAYMENT: 'SUCCESS_PAYMENT',
  FAILED_PAYMENT: 'FAILED_PAYMENT',
  NO_UPFRONT_PAYMENT: 'NO_UPFRONT_PAYMENT',
  RESERVATION_CREATED: 'RESERVATION_CREATED',
  FAILED_PAYMENT_ATTEMP: 'FAILED_PAYMENT_ATTEMP',
};
